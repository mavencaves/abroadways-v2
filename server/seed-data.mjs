...
const partnerSeeds = [
  {
    ...
    shortDescription: "Authorized testing partner information for AbroadWays students.",
    fullDescription: "AbroadWays supports LanguageCert test registration and student guidance through an authorized testing partnership.",
    partnerLogo: { imageUrl: "", altText: "LanguageCert logo", width: 180, height: 80, objectFit: "contain", objectPosition: "center", borderRadius: 0, displayMode: "responsive" },
    partnerLogoUrl: "",
    ...
    active: true,
    status: "published",
    seoTitle: "LanguageCert Partner | AbroadWays",
    seoDescription: "LanguageCert testing partner information managed by AbroadWays CMS.",
    ogImage: "/images/abroadways-hero-campus.png",
  },
  {
    id: "pearson-vue",
    ...
    shortDescription: "Authorized Pearson VUE test center information for AbroadWays.",
    fullDescription: "AbroadWays supports secure Pearson VUE computer-based test delivery through authorized test center services.",
    partnerLogo: { imageUrl: "", altText: "Pearson VUE logo", width: 180, height: 80, objectFit: "contain", objectPosition: "center", borderRadius: 0, displayMode: "responsive" },
    partnerLogoUrl: "",
    ...
    active: true,
    status: "published",
    seoTitle: "Pearson VUE Partner | AbroadWays",
    seoDescription: "Pearson VUE test center information managed by AbroadWays CMS.",
    ogImage: "/images/abroadways-hero-campus.png",
  },
  {
    id: "other-partners",
    ...
    shortDescription: "Additional partner information can be added from the CMS.",
    fullDescription: "Additional verified partners can be added and updated from the dedicated Partners CMS page.",
    partnerLogo: { imageUrl: "", altText: "Other partner logo", width: 180, height: 80, objectFit: "contain", objectPosition: "center", borderRadius: 0, displayMode: "responsive" },
    partnerLogoUrl: "",
    ...
    active: true,
    status: "published",
    seoTitle: "Other Partners | AbroadWays",
    seoDescription: "Editable partner placeholder for AbroadWays CMS.",
    ogImage: "/images/abroadways-hero-campus.png",
  },
];
