...
const homepageSections = [
  ...
  },
  {
    ...
    enabled: true,
    order: 4,
    heading: "Student Journey Stories",
    title: "Student Journey Stories",
    subtitle: "Realistic examples of how guided planning can make the process clearer.",
  ...
  {
    id: "home-consultation-cta",
    key: "consultation-cta",
    type: "consultationCta",
    enabled: true,
    order: 7,
    heading: "Claim your free Abroadways consultation",
    subtitle: "Share your country interest, study level, budget, and intake plan so our counsellors can guide the next step.",
    imageUrl: "/images/consultation-counsellor.png",
    formHeading: "Ready to begin?",
    primaryButtonText: "Start Pathway Planner",
    primaryButtonLink: "/pathway-planner",
    secondaryButtonText: "Contact Abroadways",
...
const pages = [
  {
    ...
    heroSubtitle: "Counselling, applications, visa guidance, and budget planning for Bangladeshi students choosing New Zealand, the UK, Australia, Canada, or Malaysia.",
